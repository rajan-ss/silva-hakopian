...
function silva_hakopian_scripts()
{
	...
	wp_enqueue_style('silva-hakopian-swiper', get_template_directory_uri() . '/lib/swiper/swiper-bundle.min.css', array(), SILVA_HAKOPIAN_VERSION);
	wp_enqueue_style('silva-hakopian-style', get_stylesheet_uri(), array(), SILVA_HAKOPIAN_VERSION);

	wp_enqueue_script('jquery');
	wp_enqueue_script('silva-hakopian-swiper', get_template_directory_uri() . '/lib/swiper/swiper-bundle.min.js', array(), SILVA_HAKOPIAN_VERSION, true);
