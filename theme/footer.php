...
<footer class="bg-ss-dark-blue site-footer">
	<div class="container pt-12 pb-10 flex max-lg:flex-col max-lg:items-center justify-between gap-4">
		...
		<div class="item learn-more [&_p]:mb-[10px] lg:w-4/5 leading-loose overflow-hidden text-white [&_p]:inline [&_p]:text-[13px] text-sm">
			<p><span class="font-bold text-sm block mb-4">Insurance policies and/or associated riders and features may not be available in all states.</span>
			</p>
