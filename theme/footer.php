...
?>
	...
	<footer class="bg-ss-dark-blue">
		<div class="container pt-12 pb-10 flex max-lg:flex-col max-lg:items-center justify-between gap-4">
			...
			<div class="[&_p]:mb-[10px] lg:w-4/5 leading-loose text-sm text-white first:[&_p]:font-bold">
				<p>Insurance policies and/or associated riders and features may not be available in all states.
				</p>
